...
public class Textures {
    ...
    public static final OrientedOverlayRenderer SLUICE_OVERLAY = new OrientedOverlayRenderer("machines/sluice", FRONT, SIDE);
    ...
    public static final OrientedOverlayRenderer LD_ITEM_PIPE = new OrientedOverlayRenderer("pipe/ld_item_pipe", SIDE, TOP, BOTTOM);
    public static final OrientedOverlayRenderer LD_FLUID_PIPE = new OrientedOverlayRenderer("pipe/ld_fluid_pipe", SIDE, TOP, BOTTOM);
